...
| 2 | **Quality** | `code-quality-reviewer` | DRY, naming, complexity, patterns, convention adherence |
...
| 5 | **Testing** | `test-coverage-analyzer` | Coverage gaps, untested paths, missing edge case tests |
...
| Quality | `code-quality-reviewer` | Code patterns, DRY violations, naming, complexity metrics |
...
| Quality | `code-quality-reviewer` | Everything in Standard + architecture patterns, abstraction quality |
...
| Testing | `test-coverage-analyzer` | Line/branch coverage, untested critical paths, test quality |
