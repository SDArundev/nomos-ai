...
export const FEATURE_VALID_TRANSITIONS: Record<FeatureStatus, FeatureStatus[]> = {
	...
	[FEATURE_STATUS.IN_PROGRESS]: [FEATURE_STATUS.WAITING_APPROVAL, FEATURE_STATUS.FAILED],
	[FEATURE_STATUS.WAITING_APPROVAL]: [FEATURE_STATUS.VERIFIED, FEATURE_STATUS.FAILED],
	[FEATURE_STATUS.VERIFIED]: [],
	[FEATURE_STATUS.FAILED]: [],
};
